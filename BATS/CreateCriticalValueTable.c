...
#define __PYX_HAVE__CreateCriticalValueTable
#define __PYX_HAVE_API__CreateCriticalValueTable
#include "string.h"
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from 'CreateCriticalValueTable' */
...
static PyObject *__pyx_f_24CreateCriticalValueTable_OutputCriticalValue(__Pyx_memviewslice, PyObject *, int, int, float, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_24CreateCriticalValueTable_NewCriticalValue(int, int, int, float, PyObject *); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
...
#define __Pyx_MODULE_NAME "CreateCriticalValueTable"
int __pyx_module_is_main_CreateCriticalValueTable = 0;

/* Implementation of 'CreateCriticalValueTable' */
...
static const char __pyx_k_CreateCriticalValueTable[] = "CreateCriticalValueTable";
...
static const char __pyx_k_media_zhenning_New_Volume_Githu[] = "/media/zhenning/New Volume/Github/BATS/BATS0.1/src/CreateCriticalValueTable.pyx";
...
static PyObject *__pyx_n_s_CreateCriticalValueTable;
...
static PyObject *__pyx_kp_s_media_zhenning_New_Volume_Githu;
...
static PyObject *__pyx_pf_24CreateCriticalValueTable_OutputCriticalValue(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gamma_vect, PyObject *__pyx_v_pathdir, int __pyx_v_n1, int __pyx_v_n2, float __pyx_v_clinSig); /* proto */
static PyObject *__pyx_pf_24CreateCriticalValueTable_2NewCriticalValueTable(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_seed, PyObject *__pyx_v_n1, PyObject *__pyx_v_n2, PyObject *__pyx_v_clinSig, PyObject *__pyx_v_outfile); /* proto */
...
/* "CreateCriticalValueTable.pyx":23
...
static PyObject *__pyx_pw_24CreateCriticalValueTable_1OutputCriticalValue(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_24CreateCriticalValueTable_OutputCriticalValue(__Pyx_memviewslice __pyx_v_gamma_vect, PyObject *__pyx_v_pathdir, int __pyx_v_n1, int __pyx_v_n2, float __pyx_v_clinSig, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "CreateCriticalValueTable.pyx":27
 *     # Index
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":28
 *     cdef Py_ssize_t i, j, k, m
 *     cdef int nsim = 0
 *     cdef int index0 = 0, index1 = 1             # <<<<<<<<<<<<<<
 *     cdef dict crit_dataset = {}
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":29
 *     cdef int nsim = 0
 *     cdef int index0 = 0, index1 = 1
 *     cdef dict crit_dataset = {}             # <<<<<<<<<<<<<<
 *     cdef float progress = float(n1 + 1) / 10
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":30
 *     cdef int index0 = 0, index1 = 1
 *     cdef dict crit_dataset = {}
 *     cdef float progress = float(n1 + 1) / 10             # <<<<<<<<<<<<<<
 *     # Critical value
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":34
 *     cdef float crit_arr, crit_sum
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":36
 *     clinSig = np.around(clinSig, decimals = 3)
 * 
 *     if n1 + n2 > 3000:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_6) {
    ...
    /* "CreateCriticalValueTable.pyx":38
 *     if n1 + n2 > 3000:
 * 
 *         nsim = 10000             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":42
 *     else:
 * 
 *         nsim = 20000             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":44
 *         nsim = 20000
 * 
 *     if progress <= 1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_6) {
    ...
    /* "CreateCriticalValueTable.pyx":46
 *     if progress <= 1:
 * 
 *         progress = n1 + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":49
 * 
 *     # Treatment
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":50
 *     # Treatment
 *     sys.stdout.write("Calculate critical values...")
 *     for i in range(0, n1 + 1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "CreateCriticalValueTable.pyx":54
 * 
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "CreateCriticalValueTable.pyx":56
 *         if i % progress < 1 and i >= progress:
 * 
 *            sys.stdout.write("%d percent of values calculated..." %(i / progress * 10))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "CreateCriticalValueTable.pyx":60
 * 
 *         # Control
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "CreateCriticalValueTable.pyx":62
 *         for j in xrange(0, n2 + 1):
 * 
 *             crit_sum = 0             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":63
 * 
 *             crit_sum = 0
 *             for k in xrange(0, nsim):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        ...
        /* "CreateCriticalValueTable.pyx":65
 *             for k in xrange(0, nsim):
 * 
 *                 crit_sum += CriticalValueCal(gamma_vect[index0, i, k], gamma_vect[index1, n1-i, k], gamma_vect[index1, j, k], gamma_vect[index0, n2-j, k], clinSig)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":67
 *                 crit_sum += CriticalValueCal(gamma_vect[index0, i, k], gamma_vect[index1, n1-i, k], gamma_vect[index1, j, k], gamma_vect[index0, n2-j, k], clinSig)
 * 
 *             crit_arr = crit_sum/nsim             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":68
 * 
 *             crit_arr = crit_sum/nsim
 *             crit_dataset[(i, j)] = crit_arr             # <<<<<<<<<<<<<<
 *             if crit_arr < 0.0001:
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":69
 *             crit_arr = crit_sum/nsim
 *             crit_dataset[(i, j)] = crit_arr
 *             if crit_arr < 0.0001:             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_6) {
        ...
        /* "CreateCriticalValueTable.pyx":71
 *             if crit_arr < 0.0001:
 * 
 *                 for m in range(j + 1, n2 + 1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        for (__pyx_t_14 = (__pyx_v_j + 1); __pyx_t_14 < __pyx_t_27; __pyx_t_14+=1) {
          ...
          /* "CreateCriticalValueTable.pyx":73
 *                 for m in range(j + 1, n2 + 1):
 * 
 *                     crit_dataset[(i, m)] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "CreateCriticalValueTable.pyx":75
 *                     crit_dataset[(i, m)] = 0
 * 
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":78
 * 
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":80
 *     sys.stdout.write("Output critical value look up table...")
 *     # df = pd.DataFrame(crit_dataset.values(), index=pd.MultiIndex.from_tuples(crit_dataset.keys(), names=["Treatment", "Control"]), columns=[clinSig]).sort_index()
 *     df = pd.DataFrame.from_dict(crit_dataset, "index")             # <<<<<<<<<<<<<<
 *     df.columns = [clinSig]
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":81
 *     # df = pd.DataFrame(crit_dataset.values(), index=pd.MultiIndex.from_tuples(crit_dataset.keys(), names=["Treatment", "Control"]), columns=[clinSig]).sort_index()
 *     df = pd.DataFrame.from_dict(crit_dataset, "index")
 *     df.columns = [clinSig]             # <<<<<<<<<<<<<<
 *     df.index = pd.MultiIndex.from_tuples(df.index)
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":82
 *     df = pd.DataFrame.from_dict(crit_dataset, "index")
 *     df.columns = [clinSig]
 *     df.index = pd.MultiIndex.from_tuples(df.index)             # <<<<<<<<<<<<<<
 *     df.index.names = ["Treatment", "Control"]
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":83
 *     df.columns = [clinSig]
 *     df.index = pd.MultiIndex.from_tuples(df.index)
 *     df.index.names = ["Treatment", "Control"]             # <<<<<<<<<<<<<<
 *     df = df.sort_index()
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":84
 *     df.index = pd.MultiIndex.from_tuples(df.index)
 *     df.index.names = ["Treatment", "Control"]
 *     df = df.sort_index()             # <<<<<<<<<<<<<<
 *     out_file_csv = pathdir + "/CriticalValueLookUpTable%d-%d-%.3f.csv"%(n1, n2, clinSig)
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":85
 *     df.index.names = ["Treatment", "Control"]
 *     df = df.sort_index()
 *     out_file_csv = pathdir + "/CriticalValueLookUpTable%d-%d-%.3f.csv"%(n1, n2, clinSig)             # <<<<<<<<<<<<<<
 *     df.to_csv(out_file_csv)  # write out to a csv file
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":86
 *     df = df.sort_index()
 *     out_file_csv = pathdir + "/CriticalValueLookUpTable%d-%d-%.3f.csv"%(n1, n2, clinSig)
 *     df.to_csv(out_file_csv)  # write out to a csv file             # <<<<<<<<<<<<<<
 *     del crit_dataset
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":87
 *     out_file_csv = pathdir + "/CriticalValueLookUpTable%d-%d-%.3f.csv"%(n1, n2, clinSig)
 *     df.to_csv(out_file_csv)  # write out to a csv file
 *     del crit_dataset             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":89
 *     del crit_dataset
 * 
 *     return df             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("CreateCriticalValueTable.OutputCriticalValue", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_24CreateCriticalValueTable_1OutputCriticalValue(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_24CreateCriticalValueTable_1OutputCriticalValue(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_24CreateCriticalValueTable_OutputCriticalValue(__pyx_self, __pyx_v_gamma_vect, __pyx_v_pathdir, __pyx_v_n1, __pyx_v_n2, __pyx_v_clinSig);
...
static PyObject *__pyx_pf_24CreateCriticalValueTable_OutputCriticalValue(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gamma_vect, PyObject *__pyx_v_pathdir, int __pyx_v_n1, int __pyx_v_n2, float __pyx_v_clinSig) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("OutputCriticalValue", 0);
  ...
  __pyx_t_1 = __pyx_f_24CreateCriticalValueTable_OutputCriticalValue(__pyx_v_gamma_vect, __pyx_v_pathdir, __pyx_v_n1, __pyx_v_n2, __pyx_v_clinSig, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "CreateCriticalValueTable.pyx":96
 * @cython.wraparound(False)
 * @cython.cdivision(True)
...
static PyObject *__pyx_f_24CreateCriticalValueTable_NewCriticalValue(int __pyx_v_seed, int __pyx_v_n1, int __pyx_v_n2, float __pyx_v_clinSig, PyObject *__pyx_v_outfile) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_k;
  Py_ssize_t __pyx_v_m;
  ...
  /* "CreateCriticalValueTable.pyx":100
 *     # Index
 *     cdef Py_ssize_t i, j, k, m
 *     cdef int nsim = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":101
 *     cdef Py_ssize_t i, j, k, m
 *     cdef int nsim = 0
 *     cdef int index0 = 0, index1 = 1, total_index = 2             # <<<<<<<<<<<<<<
 *     cdef max_tps = max(n1, n2) + 1
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":102
 *     cdef int nsim = 0
 *     cdef int index0 = 0, index1 = 1, total_index = 2
 *     cdef max_tps = max(n1, n2) + 1             # <<<<<<<<<<<<<<
 *     cdef dict crit_dataset = {}
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":103
 *     cdef int index0 = 0, index1 = 1, total_index = 2
 *     cdef max_tps = max(n1, n2) + 1
 *     cdef dict crit_dataset = {}             # <<<<<<<<<<<<<<
 *     #     cdef float progress = float(n1 + 1) / 100
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":105
 *     cdef dict crit_dataset = {}
 *     #     cdef float progress = float(n1 + 1) / 100
 *     cdef float progress = float(n1 + 1) / 10             # <<<<<<<<<<<<<<
 *     # Critical value
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":109
 *     cdef float crit_arr, crit_sum
 * 
 *     clinSig = np.around(clinSig, decimals = 3)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":111
 *     clinSig = np.around(clinSig, decimals = 3)
 * 
 *     if n1 + n2 > 3000:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_9) {
    ...
    /* "CreateCriticalValueTable.pyx":113
 *     if n1 + n2 > 3000:
 * 
 *         nsim = 10000             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":117
 *     else:
 * 
 *         nsim = 20000             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":119
 *         nsim = 20000
 * 
 *     if progress <= 1:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_9) {
    ...
    /* "CreateCriticalValueTable.pyx":121
 *     if progress <= 1:
 * 
 *         progress = n1 + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":124
 * 
 *     # Gamma array pointer
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":125
 *     # Gamma array pointer
 *     cdef float *gamma_array = <float *>malloc(total_index * max_tps * nsim * sizeof(float))
 *     cdef float[:, :, ::1] gamma_vect = <float[:total_index, :max_tps, :nsim]> gamma_array             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":127
 *     cdef float[:, :, ::1] gamma_vect = <float[:total_index, :max_tps, :nsim]> gamma_array
 * 
 *     if seed == 0:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_9) {
    ...
    /* "CreateCriticalValueTable.pyx":129
 *     if seed == 0:
 * 
 *         seed = np.random.randint(1, 12345, size=1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":132
 * 
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":135
 * 
 *     # Treatment
 *     sys.stdout.write("Calculate critical values...")             # <<<<<<<<<<<<<<
 *     for i in range(0, n1 + 1):
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":136
 *     # Treatment
 *     sys.stdout.write("Calculate critical values...")
 *     for i in range(0, n1 + 1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_17; __pyx_t_11+=1) {
    ...
    /* "CreateCriticalValueTable.pyx":144
 *         """
 * 
 *         if i % progress < 1 and i >= progress:             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_9) {
      ...
      /* "CreateCriticalValueTable.pyx":146
 *         if i % progress < 1 and i >= progress:
 * 
 *            sys.stdout.write("%d percent of values calculated..." %(i / progress * 10))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "CreateCriticalValueTable.pyx":150
 * 
 *         # Control
 *         for j in xrange(0, n2 + 1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
      ...
      /* "CreateCriticalValueTable.pyx":152
 *         for j in xrange(0, n2 + 1):
 * 
 *             crit_sum = 0             # <<<<<<<<<<<<<<
 *             for k in xrange(0, nsim):
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":153
 * 
 *             crit_sum = 0
 *             for k in xrange(0, nsim):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_3; __pyx_t_21+=1) {
        ...
        /* "CreateCriticalValueTable.pyx":155
 *             for k in xrange(0, nsim):
 * 
 *                 crit_sum += CriticalValueCal(gamma_vect[index0, i, k], gamma_vect[index1, n1-i, k], gamma_vect[index1, j, k], gamma_vect[index0, n2-j, k], clinSig)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":157
 *                 crit_sum += CriticalValueCal(gamma_vect[index0, i, k], gamma_vect[index1, n1-i, k], gamma_vect[index1, j, k], gamma_vect[index0, n2-j, k], clinSig)
 * 
 *             crit_arr = crit_sum/nsim             # <<<<<<<<<<<<<<
 *             crit_dataset[(i, j)] = crit_arr
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":158
 * 
 *             crit_arr = crit_sum/nsim
 *             crit_dataset[(i, j)] = crit_arr             # <<<<<<<<<<<<<<
 *             if crit_arr < 0.0001:
 ...
 */
      ...
      /* "CreateCriticalValueTable.pyx":159
 *             crit_arr = crit_sum/nsim
 *             crit_dataset[(i, j)] = crit_arr
 *             if crit_arr < 0.0001:             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_9) {
        ...
        /* "CreateCriticalValueTable.pyx":161
 *             if crit_arr < 0.0001:
 * 
 *                 for m in range(j + 1, n2 + 1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        for (__pyx_t_21 = (__pyx_v_j + 1); __pyx_t_21 < __pyx_t_34; __pyx_t_21+=1) {
          ...
          /* "CreateCriticalValueTable.pyx":163
 *                 for m in range(j + 1, n2 + 1):
 * 
 *                     crit_dataset[(i, m)] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "CreateCriticalValueTable.pyx":165
 *                     crit_dataset[(i, m)] = 0
 * 
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":168
 * 
 * 
 *     sys.stdout.write("Output critical value look up table...")             # <<<<<<<<<<<<<<
 *     # df = pd.DataFrame(crit_dataset.values(), index=pd.MultiIndex.from_tuples(crit_dataset.keys(), names=["Treatment", "Control"]), columns=[clinSig]).sort_index()
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":170
 *     sys.stdout.write("Output critical value look up table...")
 *     # df = pd.DataFrame(crit_dataset.values(), index=pd.MultiIndex.from_tuples(crit_dataset.keys(), names=["Treatment", "Control"]), columns=[clinSig]).sort_index()
 *     df = pd.DataFrame.from_dict(crit_dataset, "index")             # <<<<<<<<<<<<<<
 *     df.columns = [clinSig]
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":171
 *     # df = pd.DataFrame(crit_dataset.values(), index=pd.MultiIndex.from_tuples(crit_dataset.keys(), names=["Treatment", "Control"]), columns=[clinSig]).sort_index()
 *     df = pd.DataFrame.from_dict(crit_dataset, "index")
 *     df.columns = [clinSig]             # <<<<<<<<<<<<<<
 *     df.index = pd.MultiIndex.from_tuples(df.index)
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":172
 *     df = pd.DataFrame.from_dict(crit_dataset, "index")
 *     df.columns = [clinSig]
 *     df.index = pd.MultiIndex.from_tuples(df.index)             # <<<<<<<<<<<<<<
 *     df.index.names = ["Treatment", "Control"]
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":173
 *     df.columns = [clinSig]
 *     df.index = pd.MultiIndex.from_tuples(df.index)
 *     df.index.names = ["Treatment", "Control"]             # <<<<<<<<<<<<<<
 *     df = df.sort_index()
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":174
 *     df.index = pd.MultiIndex.from_tuples(df.index)
 *     df.index.names = ["Treatment", "Control"]
 *     df = df.sort_index()             # <<<<<<<<<<<<<<
 *     df.to_csv(outfile)  # write out to a csv file
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":175
 *     df.index.names = ["Treatment", "Control"]
 *     df = df.sort_index()
 *     df.to_csv(outfile)  # write out to a csv file             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":177
 *     df.to_csv(outfile)  # write out to a csv file
 * 
 *     free(gamma_array)             # <<<<<<<<<<<<<<
 *     del crit_dataset, df
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":178
 * 
 *     free(gamma_array)
 *     del crit_dataset, df             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":180
 *     del crit_dataset, df
 * 
 *     return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("CreateCriticalValueTable.NewCriticalValue", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "CreateCriticalValueTable.pyx":183
 * 
 * # Python wrapper for the function called by python side
...
/* Python wrapper */
static PyObject *__pyx_pw_24CreateCriticalValueTable_3NewCriticalValueTable(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_24CreateCriticalValueTable_3NewCriticalValueTable = {"NewCriticalValueTable", (PyCFunction)__pyx_pw_24CreateCriticalValueTable_3NewCriticalValueTable, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_24CreateCriticalValueTable_3NewCriticalValueTable(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("CreateCriticalValueTable.NewCriticalValueTable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_24CreateCriticalValueTable_2NewCriticalValueTable(__pyx_self, __pyx_v_seed, __pyx_v_n1, __pyx_v_n2, __pyx_v_clinSig, __pyx_v_outfile);
...
static PyObject *__pyx_pf_24CreateCriticalValueTable_2NewCriticalValueTable(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_seed, PyObject *__pyx_v_n1, PyObject *__pyx_v_n2, PyObject *__pyx_v_clinSig, PyObject *__pyx_v_outfile) {
  ...
  /* "CreateCriticalValueTable.pyx":185
 * def NewCriticalValueTable(seed, n1, n2, clinSig, outfile):
 * 
 *     import gc             # <<<<<<<<<<<<<<
 *     gc.collect()
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":186
 * 
 *     import gc
 *     gc.collect()             # <<<<<<<<<<<<<<
 *     return NewCriticalValue(seed, n1, n2, clinSig, outfile)
 */
  ...
  /* "CreateCriticalValueTable.pyx":187
 *     import gc
 *     gc.collect()
 *     return NewCriticalValue(seed, n1, n2, clinSig, outfile)             # <<<<<<<<<<<<<<
 */
  ...
  __pyx_t_1 = __pyx_f_24CreateCriticalValueTable_NewCriticalValue(__pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, ((PyObject*)__pyx_v_outfile)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "CreateCriticalValueTable.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "CreateCriticalValueTable.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "CreateCriticalValueTable.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "CreateCriticalValueTable._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"OutputCriticalValue", (PyCFunction)__pyx_pw_24CreateCriticalValueTable_1OutputCriticalValue, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_CreateCriticalValueTable, __pyx_k_CreateCriticalValueTable, sizeof(__pyx_k_CreateCriticalValueTable), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_media_zhenning_New_Volume_Githu, __pyx_k_media_zhenning_New_Volume_Githu, sizeof(__pyx_k_media_zhenning_New_Volume_Githu), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__31 = (PyObject*)__Pyx_PyCode_New(5, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__30, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_media_zhenning_New_Volume_Githu, __pyx_n_s_NewCriticalValueTable, 183, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__31)) __PYX_ERR(0, 183, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_CreateCriticalValueTable) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "CreateCriticalValueTable")) {
      if (unlikely(PyDict_SetItemString(modules, "CreateCriticalValueTable", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "CreateCriticalValueTable.pyx":12
 * 
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":14
 * import numpy as np
 * cimport numpy as np
 * import pandas as pd             # <<<<<<<<<<<<<<
 * import sys
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":15
 * cimport numpy as np
 * import pandas as pd
 * import sys             # <<<<<<<<<<<<<<
 * import GammaGenerate as GammaGenerate
 ...
 */
  ...
  /* "CreateCriticalValueTable.pyx":16
 * import pandas as pd
 * import sys
 * import GammaGenerate as GammaGenerate             # <<<<<<<<<<<<<<
 * 
 ...
 *     import gc
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_24CreateCriticalValueTable_3NewCriticalValueTable, NULL, __pyx_n_s_CreateCriticalValueTable); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_NewCriticalValueTable, __pyx_t_2) < 0) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "CreateCriticalValueTable.pyx":1
 * # Cython module             # <<<<<<<<<<<<<<
 * import cython
 * cimport cython
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init CreateCriticalValueTable", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init CreateCriticalValueTable");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
