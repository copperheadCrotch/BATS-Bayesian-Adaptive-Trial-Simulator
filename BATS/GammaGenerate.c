...
#define __PYX_HAVE__GammaGenerate
#define __PYX_HAVE_API__GammaGenerate
#include "math.h"
#include "string.h"
#include "stdio.h"
...
/* Module declarations from 'GammaGenerate' */
...
static PyObject *__pyx_f_13GammaGenerate_RandomVaribleGamma(int, int, int, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "GammaGenerate"
int __pyx_module_is_main_GammaGenerate = 0;

/* Implementation of 'GammaGenerate' */
...
static const char __pyx_k_max_tps[] = "max_tps";
...
static const char __pyx_k_F_Github_BATS_BATS1_1_src_GammaG[] = "F:\\Github\\BATS\\BATS1.1\\src\\GammaGenerate.pyx";
static const char __pyx_k_Generating_gamma_random_variable[] = "Generating gamma random variables...";
...
static PyObject *__pyx_kp_s_F_Github_BATS_BATS1_1_src_GammaG;
static PyObject *__pyx_n_s_GammaGenerate;
static PyObject *__pyx_kp_s_Generating_gamma_random_variable;
...
static PyObject *__pyx_n_s_max_tps;
...
static PyObject *__pyx_pf_13GammaGenerate_RVGamma(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_seed, PyObject *__pyx_v_max_tps, PyObject *__pyx_v_gamma_nsim, PyObject *__pyx_v_gamma_vect); /* proto */
...
static PyObject *__pyx_f_13GammaGenerate_RandomVaribleGamma(int __pyx_v_seed, int __pyx_v_max_tps, int __pyx_v_gamma_nsim, __Pyx_memviewslice __pyx_v_gamma_vect) {
  Py_ssize_t __pyx_v_m;
  Py_ssize_t __pyx_v_p;
  Py_ssize_t __pyx_v_q;
  int __pyx_v_total_index;
  gsl_rng *__pyx_v_gamma_r;
  ...
  __Pyx_RefNannySetupContext("RandomVaribleGamma", 0);

  /* "GammaGenerate.pyx":15
 * 
 *     cdef Py_ssize_t m, p, q
 ...
 * 
 */
  __pyx_v_gamma_r = gsl_rng_alloc(gsl_rng_mt19937);

  /* "GammaGenerate.pyx":17
 *     cdef int total_index = 2
 *     cdef gsl_rng *gamma_r = gsl_rng_alloc(gsl_rng_mt19937)
 *     cdef float progress = float(max_tps * total_index) / 10             # <<<<<<<<<<<<<<
 * 
 *     # Set seed
 */
  __pyx_v_progress = (((double)(__pyx_v_max_tps * __pyx_v_total_index)) / 10.0);

  /* "GammaGenerate.pyx":20
 * 
 *     # Set seed
 ...
 */
  gsl_rng_set(__pyx_v_gamma_r, __pyx_v_seed);

  /* "GammaGenerate.pyx":23
 *     # Generate gamma random variables
 *     # Set seed for gamma random variable generation
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_stdout); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_write); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_3 = __pyx_v_total_index;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_m = __pyx_t_4;

    /* "GammaGenerate.pyx":27
 *     for m in range(0, total_index):
 * 
 *         for p in range(0, max_tps):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_5 = __pyx_v_max_tps;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_p = __pyx_t_6;

      /* "GammaGenerate.pyx":29
 *         for p in range(0, max_tps):
 * 
 *             if p % progress < 1 and p >= progress:             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_8 = ((fmodf(__pyx_v_p, __pyx_v_progress) < 1.0) != 0);
      if (__pyx_t_8) {
      } else {
        __pyx_t_7 = __pyx_t_8;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_8 = ((__pyx_v_p >= __pyx_v_progress) != 0);
      __pyx_t_7 = __pyx_t_8;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_7) {

        /* "GammaGenerate.pyx":31
 *             if p % progress < 1 and p >= progress:
 * 
 *                 sys.stdout.write("%d percent of values calculated..." %((p + max_tps * m)/ progress * 10))             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_sys); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_stdout); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_write); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_t_9 = PyFloat_FromDouble((((__pyx_v_p + (__pyx_v_max_tps * __pyx_v_m)) / __pyx_v_progress) * 10.0)); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
        __pyx_t_10 = __Pyx_PyString_Format(__pyx_kp_s_d_percent_of_values_calculated, __pyx_t_9); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L1_error)
        ...
        if (!__pyx_t_9) {
          __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_10); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
          ...
          __pyx_t_10 = 0;
          __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_11, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
 ...
 */
      __pyx_t_12 = __pyx_v_gamma_nsim;
      for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
        __pyx_v_q = __pyx_t_13;

        /* "GammaGenerate.pyx":35
 *             for q in xrange(0, gamma_nsim):
 * 
 *                 gamma_vect[m, p, q] = gsl_ran_gamma(gamma_r, p + 1, 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gamma_vect.data + __pyx_t_14 * __pyx_v_gamma_vect.strides[0]) ) + __pyx_t_15 * __pyx_v_gamma_vect.strides[1]) )) + __pyx_t_16)) )) = gsl_ran_gamma(__pyx_v_gamma_r, (__pyx_v_p + 1), 1.0);
      }
    }
  }

  /* "GammaGenerate.pyx":37
 *                 gamma_vect[m, p, q] = gsl_ran_gamma(gamma_r, p + 1, 1)
 * 
 *     gsl_rng_free(gamma_r)             # <<<<<<<<<<<<<<
 * 
 *     return
 */
  gsl_rng_free(__pyx_v_gamma_r);

  /* "GammaGenerate.pyx":39
 *     gsl_rng_free(gamma_r)
 * 
 *     return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("GammaGenerate.RandomVaribleGamma", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13GammaGenerate_1RVGamma(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13GammaGenerate_1RVGamma = {"RVGamma", (PyCFunction)__pyx_pw_13GammaGenerate_1RVGamma, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13GammaGenerate_1RVGamma(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("RVGamma (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_seed,&__pyx_n_s_max_tps,&__pyx_n_s_gamma_nsim,&__pyx_n_s_gamma_vect,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_tps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RVGamma", 1, 4, 4, 1); __PYX_ERR(0, 42, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gamma_nsim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RVGamma", 1, 4, 4, 2); __PYX_ERR(0, 42, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gamma_vect)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RVGamma", 1, 4, 4, 3); __PYX_ERR(0, 42, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "RVGamma") < 0)) __PYX_ERR(0, 42, __pyx_L3_error)
      }
    ...
    __pyx_v_max_tps = values[1];
    __pyx_v_gamma_nsim = values[2];
    __pyx_v_gamma_vect = values[3];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("RVGamma", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 42, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("GammaGenerate.RVGamma", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13GammaGenerate_RVGamma(__pyx_self, __pyx_v_seed, __pyx_v_max_tps, __pyx_v_gamma_nsim, __pyx_v_gamma_vect);
...
static PyObject *__pyx_pf_13GammaGenerate_RVGamma(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_seed, PyObject *__pyx_v_max_tps, PyObject *__pyx_v_gamma_nsim, PyObject *__pyx_v_gamma_vect) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  __Pyx_RefNannySetupContext("RVGamma", 0);

  /* "GammaGenerate.pyx":44
 * def RVGamma(seed, max_tps, gamma_nsim, gamma_vect):
 * 
 *     RandomVaribleGamma(seed, max_tps, gamma_nsim, gamma_vect)             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_seed); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_v_max_tps); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_t_3 = __Pyx_PyInt_As_int(__pyx_v_gamma_nsim); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_float(__pyx_v_gamma_vect);
  if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 44, __pyx_L1_error)
  __pyx_t_5 = __pyx_f_13GammaGenerate_RandomVaribleGamma(__pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 44, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "GammaGenerate.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "GammaGenerate._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_F_Github_BATS_BATS1_1_src_GammaG, __pyx_k_F_Github_BATS_BATS1_1_src_GammaG, sizeof(__pyx_k_F_Github_BATS_BATS1_1_src_GammaG), 0, 0, 1, 0},
  {&__pyx_n_s_GammaGenerate, __pyx_k_GammaGenerate, sizeof(__pyx_k_GammaGenerate), 0, 0, 1, 1},
  {&__pyx_kp_s_Generating_gamma_random_variable, __pyx_k_Generating_gamma_random_variable, sizeof(__pyx_k_Generating_gamma_random_variable), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_max_tps, __pyx_k_max_tps, sizeof(__pyx_k_max_tps), 0, 0, 1, 1},
 ...
 *     for m in range(0, total_index):
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Generating_gamma_random_variable); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 *     RandomVaribleGamma(seed, max_tps, gamma_nsim, gamma_vect)
 */
  __pyx_tuple__15 = PyTuple_Pack(4, __pyx_n_s_seed, __pyx_n_s_max_tps, __pyx_n_s_gamma_nsim, __pyx_n_s_gamma_vect); if (unlikely(!__pyx_tuple__15)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__15);
  __Pyx_GIVEREF(__pyx_tuple__15);
  __pyx_codeobj__16 = (PyObject*)__Pyx_PyCode_New(4, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__15, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_F_Github_BATS_BATS1_1_src_GammaG, __pyx_n_s_RVGamma, 42, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__16)) __PYX_ERR(0, 42, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initGammaGenerate(void); /*proto*/
PyMODINIT_FUNC initGammaGenerate(void)
#else
PyMODINIT_FUNC PyInit_GammaGenerate(void); /*proto*/
PyMODINIT_FUNC PyInit_GammaGenerate(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_GammaGenerate(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("GammaGenerate", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_GammaGenerate) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "GammaGenerate")) {
      if (unlikely(PyDict_SetItemString(modules, "GammaGenerate", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     RandomVaribleGamma(seed, max_tps, gamma_nsim, gamma_vect)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13GammaGenerate_1RVGamma, NULL, __pyx_n_s_GammaGenerate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_RVGamma, __pyx_t_1) < 0) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init GammaGenerate", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init GammaGenerate");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
